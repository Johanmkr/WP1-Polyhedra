...
(see `new_estimator_implementation.md`). Bias recursion confirmed against
...
6. **Decide whether to address the open items** in
   `new_estimator_implementation.md` §12 (MM correction in legacy
...
- `new_estimator_implementation.md` — full implementation log.
- `compatability_analysis.md` — original six-question codebase analysis.
- `claude_new_estimator_instructions.md` — original spec.
...
`new_estimator_implementation.md`. Everything else is reconstructable from
those two.
